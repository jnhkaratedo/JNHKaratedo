    ...
    <div class="content-wrapper">
      <div class="row">
        <div class="col-12 grid-margin stretch-card">
          <div class="card">
            <div class="card-body">
              <h4 class="card-title"><label>Enrollment Form</label><LABEL
                  style="float: right;">Date:<?php echo date("y-m-d")?></LABEL></h4>
              ...
              <form class="forms-sample" method="post" action="process.php">
                ...
                <div class="form-group">
                  ...
                  <input type="text" name="name" id="name" class="form-control " required=""
                    value="<?php if (isset($_GET['edit'])){echo $row['Name'];}else if(isset($_GET['appr'])){echo $row['Name'];} ?>">
                </div>
                <div class="form-group">
                ...
                <div class="form-group" style="width: 40%; padding: 10px; float: left;">
                  ...
                  <input type="text" class="form-control" name="contact" id="contact" required=""
                    value="<?php if (isset($_GET['edit'])){echo $row['Contact_No'];}else if(isset($_GET['appr'])){echo $row['Contact_No'];}?>">
                </div>
                ...
                <div class="form-group" style=" float:left; width:50%; padding: 10px;">
                  ...
                  <input type="text" class="form-control" name="fname" id="fname"
                    value="<?php if (isset($_GET['edit'])){echo $row['Fathers_Name'];}?>">
                </div>
                <div class="form-group" style=" float:left; width: 20%; padding:10px;">
                  <label for="FOccupation">Occupation</label>
                  <input type="text" class="form-control" name="FOccupation" id="FOccupation"
                    value="<?php if (isset($_GET['edit'])){echo $row['FOccupation'];}?>">
                </div>
                <div class="form-group" style="float: left;width: 30%; padding:10px;">
                  <label for="Fcontact">Contact Number</label>
                  <input type="text" class="form-control" name="Fcontact" id="Fcontact"
                    value="<?php if (isset($_GET['edit'])){echo $row['FContact_No'];}?>">
                </div>
                <div class="form-group" style="float:left; width:50%; padding: 10px;">
                  <label for="mname">Mother's Name</label>
                  <input type="text" class="form-control" name="mname" id="mname"
                    value="<?php if (isset($_GET['edit'])){echo $row['Mothers_Name'];}?>">
                </div>
                <div class="form-group" style="float:left; width: 20%; padding:10px;">
                  <label for="MOccupation">Occupation</label>
                  <input type="text" class="form-control" name="MOccupation" id="MOccupation"
                    value="<?php if (isset($_GET['edit'])){echo $row['MOccupation'];}?>">
                </div>
                <div class="form-group" style="float:left; width: 30%; padding:10px;">
                  <label for="Mcontact">Contact Number</label>
                  <input type="Number" class="form-control" name="Mcontact" id="Mcontact"
                    value="<?php if (isset($_GET['edit'])){echo $row['MContact_No'];}?>">
                </div>
                <div class="form-group" style="float: left; width: 30%; padding: 10px;">
                  <label for="Gcontact">Payment</label>
                  <input type="text" class="form-control" id="Payment" name="Payment"
                    value="<?php if (isset($_GET['edit'])){echo $row['Payment'];}?>">
                </div>
                <div class="form-group" style="float:left; width: 70%; padding: 10px;">
                  <label for="Comment">Have you joined other Martial Arts? If Yes, What Club, Style, Rank and Name of
                    your previous Instructor?</label>
                  <input type="text" class="form-control" id="Comment" name="Comment" style="height: 70px; width:100%;"
                    value="<?php if (isset($_GET['edit'])){echo $row['Comment'];}?>">
                </div>
                <?php if (isset($_GET['edit'])){?>
                <button type="submit" name="btnenroll" id="btnenroll" class="btn btn-primary mr-2"
                  style="float: left;">Enroll</button>
                <?php }else if(isset($_GET['appr'])){?>
                <button type="submit" name="btnenrollr" id="btnenrollr" class="btn btn-primary mr-2"
                  style="float: left;">Enroll</button>
                <?php } else{ ?>
                <button type="submit" name="btnenroll" id="btnenroll" class="btn btn-primary mr-2"
                  style="float: left;">Enroll</button>
                  ...
                  <div class="card-body">
                    ...
                    <form class="forms-sample" method="post" action="process.php">
                      ...
                      <div class="form-group">
                        <label for="name">Name</label>
                        <input type="text" name="name" id="name" class="form-control " required=""
                          value="<?php if(isset($_GET['edit2'])){echo $row['Name'];}?> ">
                      </div>
                      <div class="form-group" style="width: 70%; float: left; padding: 10px;">
                        <label for="Address">Address</label>
                        <input type="text" class="form-control " name="Address" id="Address" required=""
                          value="<?php if(isset($_GET['edit2'])){echo $row['Address'];}?> ">
                      </div>
                      <div class="form-group" style="width: 30%; padding: 10px; float:left;"">
                      <label for=" Birthday">Email</label>
                        <input type="email" class="form-control" name="Email" id="Email" required=""
                          value="<?php if(isset($_GET['edit2'])){echo $row['Email'];}?> ">
                      </div>
                      <div class="form-group" style="width: 20%; padding: 10px; float: left;">
                        <label for="Birthday">Birthday</label>
                        <input type="date" class="form-control" name="Birthday" id="Birthday" required=""
                          value="<?php if (isset($_GET['edit2'])){echo $row['Birthday'];}?>">
                      </div>
                      <div class="form-group" style="width: 10%; padding: 10px; float: left;">
                        <label for="Age">Age</label>
                        <input type="data-toggle" class="form-control" name="Age" id="Age"
                          value="<?php if(isset($_GET['edit2'])){echo $row['Age'];}?> ">
                      </div>
                      <div class="form-group" style="width: 20%; padding: 10px; float: left;">
                        <label for="Gender">Gender</label>
                        <select class="form-control" id="Gender" name="Gender" required="">
                      ...
                      <div class="form-group" style="width: 50%; padding: 10px; float: left;">
                        <label for="contact">Contact Number</label>
                        <input type="text" class="form-control" name="contact" id="contact" required=""
                          value="<?php if(isset($_GET['edit2'])){echo $row['Contact_No'];}?>">
                      </div>
                      <hr>
                      <?php if(isset($_GET['edit2'])){ ?>
                      <button type="submit" name="btnupdate2" id="btnupdate2"
                        class="btn btn-primary mr-2">Update</button> <?php }else{ ?>
