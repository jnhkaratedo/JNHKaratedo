                ...
                <div class="col-12 grid-margin stretch-card">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form class="forms-sample" method="post" action="instructor_add.php">
                                <div class="form-group">
                                    <label for="Rank">Rank</label>
                                    <select class="form-control" id="Rank" name="Rank"
                                        style="width:120px; height: 40px;" required="">
                      ...
                      <label for=" Birthday">Email</label>
                                ...
                                <div class="form-group" style="width: 10%; padding: 10px; float: left;">
                                    ...
                                    <input type="data-toggle" class="form-control" name="Age" id="Age" value=" ">
                                </div>
                                <div class="form-group" style="width: 20%; padding: 10px; float: left;">
